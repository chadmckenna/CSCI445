...
<body onload="random_images()">
	<div class="container">
	  ...
	  ?>
		...
		<div id="prices">
		  <?php
		    echo "PBR - $".number_format($prices["pbr"], 2). " per can. ";
		    echo "Coors - $".number_format($prices["coors"], 2). " per can. ";
		    echo "Trout Slayer - $".number_format($prices["ts"], 2). " per bottle. ";
		  ?>
		</div>
			...
			<table>
			  ...
			  <tr>
				...
				<tr>
					<td>Trout Slayer</td>
					<td>
						<input type="text" name="trout_slayer" />
					</td>
					<td>
						<select name="ts_size">
							<option value="6">6 Pack</option>
